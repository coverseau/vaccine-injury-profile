	...
	symptoms: {
		severity: {
			...
			'insomnia': {
				...
				'moderate': 16.4644714038128,
				'moderately severe': 13.3448873483536,
				'severe': 23.3968804159445,
				'N/A': 17.157712305026
			},
			'sleep disturbances': {
				N: 517,
				...
				'moderate': 17.6776429809359,
				'moderately severe': 18.1975736568458,
				'severe': 28.5961871750433,
				'N/A': 10.051993067591
			},
			'excessive sleep': {
				N: 503,
				'minimal': 14.3847487001733,
				'mild': 9.01213171577123,
				'moderate': 13.1715771230503,
				'moderately severe': 11.4384748700173,
				'severe': 15.0779896013865,
				'N/A': 24.0901213171577
			},
			'paralysis': {
				N: 493,
			...
			'resurgence of latent disease (e.g. shingles, EBV, cancer, autoimmune disease, etc.)': {
				N: 472,
				'minimal': 5.02599653379549,
				'mild': 2.59965337954939,
				'moderate': 4.50606585788562,
				'moderately severe': 5.02599653379549,
				'severe': 16.4644714038128,
				'N/A': 48.1802426343154
			}
		},
		other: {
